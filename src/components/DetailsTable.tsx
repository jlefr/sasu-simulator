    ...
    <>
      <table className={styles.innerTable}>
        <tbody>
          ...
          <tr>
            ...
            <td className={styles.right} rowSpan={6}>
              {formatEuro(-item.salaire.superBrut)}
            </td>
            <td>Super brut</td>
          ...
          <tr>
            ...
            <td>
              <b>{formatEuro(item.benefices.brut)}</b>
            </td>
          </tr>
          <tr>
            <td rowSpan={3}>Impôt sur les sociétés</td>
            <td rowSpan={3} className={styles.right}>
              {formatEuro(-item.benefices.is)}
            </td>
          ...
          <tr>
            ...
            <td>
              <b>{formatEuro(item.benefices.net)}</b>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className={styles.right}>
              {formatEuro(-item.dividendes.depuisBenefice)}
            </td>
          </tr>
          <tr>
            <td>
              ...
              <b>
                {formatEuro(
                  item.ca.total -
                    ...
                    item.benefices.is -
                    item.reserve.total -
                    item.dividendes.depuisBenefice
                )}
              </b>
            </td>
          </tr>
      ...
      <table className={styles.innerTable}>
        <tbody>
          <tr>
            ...
            <td rowSpan={2}>
              <b>{formatEuro(item.dividendes.brut)}</b>
            </td>
          ...
          {item.dividendes.pfuImpotsRevenu !== 0 && (
            <>
              <tr>
                <td rowSpan={2}>
                  Prélèvements forfaitaire {formatPercent(configDividende.pfu)}
                </td>
                <td rowSpan={2} className={styles.right}>
                  {formatEuro(
                    -(
                      item.dividendes.prelevementsSociaux +
                      item.dividendes.pfuImpotsRevenu
                    )
                  )}
                </td>
                <td>
                  Prélèvements sociaux{" "}
                  {formatPercent(configDividende.prelevementsSociaux)}
                </td>
              ...
              <tr>
                <td>
                  Impôt sur le revenu{" "}
                  {formatPercent(configDividende.pfuImpotsRevenu)}
                </td>
          ...
          <tr>
            ...
            <td>
              <b>{formatEuro(item.dividendes.net)}</b>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table className={styles.innerTable}>
        <tbody>
          <tr>
            <td rowSpan={3}>
              <b>Revenus avant impôts</b>
            </td>
            <td rowSpan={3}>
              <b>{formatEuro(item.impots.avant)}</b>
            </td>
            <td>Salaire net</td>
            <td>{formatEuro(item.salaire.net)}</td>
          </tr>
          ...
          <tr>
            ...
            <td className={styles.right}>
              -{formatEuro(item.impots.deductionFraisPro)}
            </td>
          </tr>
          {item.dividendes.pfuImpotsRevenu !== 0 && (
            <>
          ...
          {item.dividendes.pfuImpotsRevenu === 0 && (
            <>
              ...
              <tr>
                ...
                <td className={styles.right}>
                  {formatEuro(-item.dividendes.abattement)}
                </td>
              </tr>
              <tr>
                <td>
                  CSG déductible {formatPercent(configDividende.csgDeductible)}
                </td>
                <td className={styles.right}>
                  {formatEuro(-item.dividendes.csgDeduite)}
                </td>
              </tr>
            </>
          )}
          ...
          <tr>
            ...
            <td rowSpan={configIR.taux.length + 1} className={styles.right}>
              {formatEuro(-item.impots.montant)}
            </td>
            <td>De 0 à {formatEuro(configIR.tranches[0])}</td>
            <td>{formatPercent(configIR.taux[0])}</td>
          </tr>
          {Array.from({ length: configIR.taux.length - 2 }, (v, k) => (
            <tr>
              <td>
                De {formatEuro(configIR.tranches[k] + 1)} à{" "}
                {formatEuro(configIR.tranches[k + 1])}
              </td>
          ...
          <tr>
            <td>
              Après{" "}
              {formatEuro(configIR.tranches[configIR.tranches.length - 1])}
            </td>
          ...
          <tr>
            <td>
              <b>Revenus après impôts</b>
            </td>
            <td>
              <b>{formatEuro(item.impots.apres)}</b>
            </td>
          </tr>
        </tbody>
      </table>
